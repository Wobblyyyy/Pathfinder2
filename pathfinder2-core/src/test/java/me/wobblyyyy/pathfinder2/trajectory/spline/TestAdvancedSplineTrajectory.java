...
public class TestAdvancedSplineTrajectory extends TestableRobot {
    ...
    private void testSplineTo(PointXYZ... points) {
        if (points.length < 1) throw new IllegalArgumentException();
    ...
    public void testTurningNonLinearSpline() {
        testSplineTo(
            new PointXYZ(0, 0, 45),
            new PointXYZ(5, 5, 65),
            new PointXYZ(10, 15, 90),
            new PointXYZ(15, 30, 180)
        );
    }
    ...
    public void testInvalidSplines() {
        Assertions.assertThrows(
            ...
            () -> {
                new MonotoneCubicSpline(new double[] { 0 }, new double[] { 0 });
            }
        );
        ...
        Assertions.assertThrows(
            SplineException.class,
            () -> {
                new MonotoneCubicSpline(new double[] { 0 }, null);
            }
        );
    }
