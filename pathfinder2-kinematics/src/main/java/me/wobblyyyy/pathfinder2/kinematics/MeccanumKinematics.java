...
/**
 * Kinematics for a meccanum chassis.
 *
 * @author Colin Robertson
 * @since 0.5.0
 */
public class MeccanumKinematics implements Kinematics<MeccanumState> {
    ...
    public MeccanumKinematics(double xSize,
                              double ySize) {
        this(
    ...
    public MeccanumState calculate(Translation translation,
        ...
        return new MeccanumState(fr, fl, br, bl);
    }
